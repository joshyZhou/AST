...
import options
######### parser ###########
opt = options.Options().init(argparse.ArgumentParser(description='Image dehazing')).parse_args()
print(opt)
...
######### Logs dir ###########
log_dir = os.path.join(opt.save_dir, 'dehazing', opt.dataset, opt.arch+opt.env)
