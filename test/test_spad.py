...
parser.add_argument('--result_dir', default='./results/deraining/spad/AST_B/',
    type=str, help='Directory for results')
parser.add_argument('--weights', default='./pretrained/rain/model_best.pth',
...
parser.add_argument('--token_mlp', type=str,default='frfn', help='ffn/leff token mlp')
