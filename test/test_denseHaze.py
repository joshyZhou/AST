...
parser = argparse.ArgumentParser(description='Image dehazing evaluation on DenseHaze')
parser.add_argument('--input_dir', default='/PATH/TO/DATASET/',
    type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results_release/haze/densehaze/AST_B/',
    type=str, help='Directory for results')
parser.add_argument('--weights', default='./pretrained/haze/model_best.pth',
