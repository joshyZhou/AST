...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--pretrain_weights',type=str, default='./log/AST_B/models/model_best.pth', help='path of pretrained_weights')
        ...
        parser.add_argument('--arch', type=str, default ='AST_B',  help='archtechture')
        ...
        parser.add_argument('--token_mlp', type=str,default='leff', help='ffn/leff token mlp/leff_mpconv')
        ...
        parser.add_argument('--train_dir', type=str, default ='./rain_syn/DDN-Data/train/',  help='dir of train data')
        parser.add_argument('--val_dir', type=str, default ='./rain_syn/DDN-Data/test/',  help='dir of train data')
